...
class EPWC_Gateway_VirtualIban_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_virtualiban_checkout');
        ...
        $this->id = 'virtualiban_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/tb-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/tb-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Virtual IBAN (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('A simple bank transfer', 'easypay-checkout-for-woocommerce');
        ...
        $this->method = "virtualiban_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Virtual IBAN Payment Gateway.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Virtual IBAN (Bank Transfer)', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('A simple bank transfer', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Virtual IBAN Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Receive the IBAN to make a bank transfer, without the need to send a payment receipt.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="virtualiban_checkout"></div>';
