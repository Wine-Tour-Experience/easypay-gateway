...
class EPWC_Gateway_Multibanco_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_multibanco_checkout');
        ...
        $this->id = 'multibanco_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/multibanco-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/multibanco-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Multibanco Reference (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Receive a Multibanco reference that you can pay through your online banking or at an ATM', 'easypay-checkout-for-woocommerce');
        ...
        $this->method = "multibanco_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Ref. Multibanco Payment.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Payment with Ref. Multibanco', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Receive a Multibanco reference that you can pay through your online banking or at an ATM', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Ref. Multibanco Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Ref. Multibanco works by giving the user the payment information.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="multibanco_checkout"></div>';
