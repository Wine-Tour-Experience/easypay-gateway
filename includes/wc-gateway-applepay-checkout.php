...
class EPWC_Gateway_ApplePay_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_applepay_checkout');
        ...
        $this->id = 'applepay_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/applepay-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/applepay-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Apple Pay (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Enter the payment information and receive a notification in the Apple Pay app to approve.', 'easypay-checkout-for-woocommerce');
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Apple Pay Payment Gateway.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Apple Pay', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Enter the payment information and receive a notification in the Apple Pay app to approve.', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Apple Pay Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Apple Pay standard works by sending the user to payment information.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="applepay_checkout"></div>';
