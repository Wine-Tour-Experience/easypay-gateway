...
class EPWC_Gateway_Mbway_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_mbway_checkout');
        ...
        $this->id = 'mbway_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/mbway-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/mbway-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('MB Way (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Automatic payment with approval in the MB Way app.', 'easypay-checkout-for-woocommerce');
        ...
        $this->title = $this->get_option('title') ? $this->get_option('title') : esc_html__('MB Way', 'easypay-checkout-for-woocommerce');

        $this->description = $this->get_option('description');

        $this->currency = 'EUR';

        $this->method = "mbway_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable MB Way Payment Gateway.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('MB Way', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Automatic payment with approval in the MB Way app.', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('MB Way Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Enter the payment information and receive a notification in the MB Way app to approve.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="mbway_checkout"></div>';
