...
class EPWC_Gateway_UniversoFlex_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_universoflex_checkout');
        ...
        $this->id = 'universoflex_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/uf-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/uf-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Universo Flex (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Installment payment in 3X interest-free or 6/12X with interest directly through the Universo app', 'easypay-checkout-for-woocommerce');
        ...
        $this->method = "universoflex_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Universo Flex Payment.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Universo Flex', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Installment payment in 3X interest-free or 6/12X with interest directly through the Universo app', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Universo Flex Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Universo Flex standard works by sending the user to Universo APP.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="universoflex_checkout"></div>';
