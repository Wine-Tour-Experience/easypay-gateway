...
class EPWC_Gateway_CreditCard_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_creditcard_checkout');
        ...
        $this->id = 'creditcard_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/visa-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/visa-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Visa&Mastercard Card (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Easy and safe payment', 'easypay-checkout-for-woocommerce');
        ...
        $this->method = "creditcard_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Visa & Mastercard Card Payment.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Visa&Mastercard Card', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Easy and safe payment', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Visa & Mastercard Card Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('To pay with Visa & Mastercard, you just need to enter your payment information.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="creditcard_checkout"></div>';
