...
class EPWC_Gateway_SantanderConsumer_Checkout extends WC_Payment_Gateway

{
...

    {
        ...
        $settings_url = esc_url(get_admin_url().'admin.php?page=wc-settings&amp;tab=checkout&amp;section=wc_payment_gateway_santanderconsumer_checkout');
        ...
        $this->id = 'santanderconsumer_checkout';



        $this->icon = apply_filters('woocommerce_custom_payment_gateway_icon', plugin_dir_url(__DIR__).'images/logos/santander-wide.png');



        $this->pg_icons  = plugins_url('../images/logos/santander-wide.png', __FILE__);



        $this->has_fields = false;

        $this->method_title = esc_html__('Santander Consumer Finance (easypay)', 'easypay-checkout-for-woocommerce');

        $this->method_description = esc_html__('Pay with online credit in a simple and fast way directly with Santander Consumer Finance.', 'easypay-checkout-for-woocommerce');
        ...
        $this->title = $this->get_option('title') ? $this->get_option('title') : esc_html__('Santander Consumer Finance', 'easypay-checkout-for-woocommerce');
        ...
        $this->method = "santanderconsumer_checkout";
...

    {
        ...
        $this->form_fields = [
            ...
            'enabled' => [
                ...
                'label' => esc_html__('Enable Santander Consumer Payment.', 'easypay-checkout-for-woocommerce'),
            ...
            'title' => [
                ...
                'default' => esc_html__('Santander Consumer Finance', 'easypay-checkout-for-woocommerce'),
            ...
            'description' => [
                ...
                'default' => esc_html__('Pay with online credit in a simple and fast way directly with Santander Consumer Finance.', 'easypay-checkout-for-woocommerce'),
...

    {
        ...
        ?>
            ...
            <h3><?php echo esc_html__('Santander Consumer Finance Settings', 'easypay-checkout-for-woocommerce'); ?></h3>

            <p><?php echo esc_html__('Santander Consumer standard works by sending the user to Santander Consumer Finance APP.', 'easypay-checkout-for-woocommerce'); ?></p>
...

    {
        ...
        return '<div id="santanderconsumer_checkout" </div>';
